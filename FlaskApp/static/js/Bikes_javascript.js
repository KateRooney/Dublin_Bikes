...
function initMap() {
        ...
        $.getJSON("http://127.0.0.1:5000/stations", null, function (stations)
                         {
         ...
         var heatmap = $.getJSON("http://127.0.0.1:5000/stations", null,function(stations) {
     ...
     function drawChart (){
    	 //peak_times_chart
    	 	var forChart = $.getJSON("http://127.0.0.1:5000/peak", null,function (peak) {
    	 	var peak = peak.peak;
    	    for (var p=0; p<1; p++)
     	...
     	//off_peak_times_chart
 	 	var forChart2 = $.getJSON("http://127.0.0.1:5000/off_peak", null,function (off_peak) {
